...
Invalid_edge_preprocessing_3::Invalid_edge_preprocessing_3 (EMH_model& emh_model) : Preprocessing_emh_model (emh_model) {
...
void Invalid_edge_preprocessing_3::add () {
  list<pair<int, int>> edges = get_invalid_edges_3(emh_model.instance);
