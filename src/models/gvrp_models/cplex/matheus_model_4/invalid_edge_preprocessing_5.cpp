...
#include "models/gvrp_models/cplex/matheus_model_4/invalid_edge_preprocessing_5.hpp"
...
Invalid_edge_preprocessing_5::Invalid_edge_preprocessing_5 (Matheus_model_4& matheus_model_4) : Preprocessing (matheus_model_4) {
        ...
        for (int r = 0; r < matheus_model_4._f.size(); ++r) {
          ...
          for (int f_ = 0; f_ < matheus_model_4._f.size(); ++f_) {
            ...
            for (int r_ = 0; r_ < matheus_model_4._f.size(); ++r_) {
              const Vertex * vertexR_ = matheus_model_4._f[r_];
              if ((f_ != f || r_ != r) && 
                  matheus_model_4.customerToAfsFuel(i, f_) <= matheus_model_4.customerToAfsFuel(i, f) &&
                  matheus_model_4.afsToCustomerFuel(r_, j) <= matheus_model_4.afsToCustomerFuel(r, j) &&
                  matheus_model_4.instance.time(vertexI->id, vertexF_->id) <= matheus_model_4.instance.time(vertexI->id, vertexF->id) &&
                  matheus_model_4.instance.time(vertexR_->id, vertexJ->id) <= matheus_model_4.instance.time(vertexR->id, vertexJ->id) &&
                  matheus_model_4.instance.distances[vertexI->id][vertexF_->id] <= matheus_model_4.instance.distances[vertexI->id][vertexF->id] &&
                  matheus_model_4.instance.distances[vertexR_->id][vertexJ->id] <= matheus_model_4.instance.distances[vertexR->id][vertexJ->id]) {
                ...
                if (matheus_model_4.gvrp_afs_tree->pairTimes[f2][r2] <= matheus_model_4.gvrp_afs_tree->pairTimes[f1][r1] &&
                  ...
                  ++matheus_model_4.nPreprocessings5;
                  matheus_model_4.model.add(matheus_model_4.y[i][f][r][j] == 0);
                  f_ = matheus_model_4.gvrp_afs_tree->f0.size();
                  break;
                }
              }
            }
