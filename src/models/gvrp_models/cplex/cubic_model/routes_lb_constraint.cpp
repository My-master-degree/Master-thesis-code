...
#include "models/gvrp_models/cplex/cubic_model/routes_lb_constraint.hpp"
...
Routes_lb_constraint::Routes_lb_constraint (Cubic_model& cubic_model) : Extra_constraint (cubic_model) {}
