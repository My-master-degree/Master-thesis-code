...
Mip_start::Mip_start (const Gvrp_instance& instance, unsigned int time_limit, Gvrp_solution& gvrp_solution_) : Matheus_model (instance, time_limit), gvrp_solution (gvrp_solution_) {
}
