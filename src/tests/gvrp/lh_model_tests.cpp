...
void LH_model_tests::run() {
  ...
  for (const string& instance : instances) {
    ...
    lh_model.preprocessings.push_back(new Invalid_edge_preprocessing_2(lh_model));
    lh_model.preprocessings.push_back(new Invalid_edge_preprocessing_3(lh_model));
    lh_model.preprocessings.push_back(new Invalid_edge_preprocessing_4(lh_model));
    */
