#ifndef INVALID_EDGE_PREPROCESSING_2_KK_MODEL_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_2_KK_MODEL_CPLEX_HPP_
    ...
    namespace cplex {
      namespace kk_model {
        class Invalid_edge_preprocessing_2 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_2 (KK_model& kk_model);
            void add ();
        };
      }
    }
