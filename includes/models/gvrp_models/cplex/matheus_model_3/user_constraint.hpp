#ifndef USER_CONSTRAINT_MATHEUS_MODEL_3_CPLEX_HPP_
#define USER_CONSTRAINT_MATHEUS_MODEL_3_CPLEX_HPP_
      ...
      namespace matheus_model_3 {
        ...
        class User_constraint : public IloCplex::UserCutCallbackI {
          protected:
            ...
            const double EPS;
          public:
            explicit User_constraint (Matheus_model_3& matheus_model_3);
        };    
      }
    }
  }
