#ifndef INVALID_EDGE_PREPROCESSING_2_MATHEUS_MODEL_3_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_2_MATHEUS_MODEL_3_CPLEX_HPP_
    ...
    namespace cplex {
      namespace matheus_model_3 {
        class Invalid_edge_preprocessing_2 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_2 (Matheus_model_3& matheus_model_3);
            void add ();
        };
      }
    }
