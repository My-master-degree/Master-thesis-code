#ifndef INVALID_EDGE_PREPROCESSING_4_LH_MODEL_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_4_LH_MODEL_CPLEX_HPP_
    ...
    namespace cplex {
      namespace lh_model {
        class Invalid_edge_preprocessing_4 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_4 (LH_model& lh_model);
            void add ();
        };
      }
    }
