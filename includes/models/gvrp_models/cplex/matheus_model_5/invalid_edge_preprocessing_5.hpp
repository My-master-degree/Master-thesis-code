#ifndef INVALID_EDGE_PREPROCESSING_5_MATHEUS_MODEL_5_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_5_MATHEUS_MODEL_5_CPLEX_HPP_
    ...
    namespace cplex {
      namespace matheus_model_5 {
        class Invalid_edge_preprocessing_5 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_5 (Matheus_model_5& matheus_model_5);
            void add ();
        };
      }
    }
