#ifndef INVALID_EDGE_PREPROCESSING_2_MATHEUS_MODEL_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_2_MATHEUS_MODEL_CPLEX_HPP_
    ...
    namespace cplex {
      namespace matheus_model {
        class Invalid_edge_preprocessing_2 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_2 (Matheus_model& matheus_model);
            void add ();
        };
      }
    }
