#ifndef INVALID_EDGE_PREPROCESSING_3_MATHEUS_MODEL_2_CPLEX_HPP_
#define INVALID_EDGE_PREPROCESSING_3_MATHEUS_MODEL_2_CPLEX_HPP_
    ...
    namespace cplex {
      namespace matheus_model_2 {
        class Invalid_edge_preprocessing_3 : public Preprocessing {
          public:
            explicit Invalid_edge_preprocessing_3 (Matheus_model_2& matheus_model_2);
            void add ();
        };
      }
    }
